...
/**
 * Represents a configurable entity virtual_datetime field.
 */
class Virtual_DateTimeFieldItemList extends FieldItemList {
  ...
  public static function processDefaultValue($default_value, FieldableEntityInterface $entity, FieldDefinitionInterface $definition) {
    ...
    if (isset($default_value[0]['default_date_type'])) {
      if ($definition->getSetting('virtual_datetime_type') === Virtual_DateTimeItem::VIRTUAL_DATETIME_TYPE_DATE) {
        ...
        // for date storage.
        $date = new DrupalDateTime($default_value[0]['default_date'], VIRTUAL_DATETIME_STORAGE_TIMEZONE);
