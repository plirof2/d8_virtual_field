...
/**
 * Plugin implementation of the 'Custom' formatter for 'virtual_datetime' fields.
 *
 * @FieldFormatter(
 *   id = "virtual_datetime_custom",
 ...
 *)
 */
class Virtual_DateTimeCustomFormatter extends Virtual_DateTimeFormatterBase {
  ...
  public static function defaultSettings() {
    return [
      'date_format' => VIRTUAL_DATETIME_VIRTUAL_DATETIME_STORAGE_FORMAT,
