...
/**
 * Plugin implementation of the 'Time ago' formatter for 'virtual_datetime' fields.
 *
 * @FieldFormatter(
 *   id = "virtual_datetime_time_ago",
 ...
 * )
 */
class Virtual_DateTimeTimeAgoFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a Virtual_DateTimeTimeAgoFormatter object.
   *
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $output = [];
      if (!empty($item->date)) {
        if ($this->getFieldSetting('virtual_datetime_type') == 'date') {
