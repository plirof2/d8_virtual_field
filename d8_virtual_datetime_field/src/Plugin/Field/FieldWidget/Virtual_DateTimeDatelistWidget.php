...
/**
 * Plugin implementation of the 'virtual_datetime_datelist' widget.
 *
 * @FieldWidget(
 *   id = "virtual_datetime_datelist",
 ...
 * )
 */
class Virtual_DateTimeDatelistWidget extends Virtual_DateTimeWidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if ($this->getFieldSetting('virtual_datetime_type') == 'virtual_datetime') {
