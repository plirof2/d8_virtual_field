...
namespace Drupal\virtual_datetime\Plugin\views\filter;
...
class Date extends NumericDate implements ContainerFactoryPluginInterface {
   ...
   */
  protected $dateFormat = VIRTUAL_DATETIME_VIRTUAL_DATETIME_STORAGE_FORMAT;
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, DateFormatterInterface $date_formatter, RequestStack $request_stack) {
    ...
    if ($definition->getSetting('virtual_datetime_type') === Virtual_DateTimeItem::VIRTUAL_DATETIME_TYPE_DATE) {
      $this->dateFormat = VIRTUAL_DATETIME_DATE_STORAGE_FORMAT;
    }
  }
  ...
  protected function opBetween($field) {
    ...
    $a = $this->query->getDateFormat("'" . $this->dateFormatter->format($a, 'custom', VIRTUAL_DATETIME_VIRTUAL_DATETIME_STORAGE_FORMAT, VIRTUAL_DATETIME_STORAGE_TIMEZONE) . "'", $this->dateFormat, TRUE);
    $b = $this->query->getDateFormat("'" . $this->dateFormatter->format($b, 'custom', VIRTUAL_DATETIME_VIRTUAL_DATETIME_STORAGE_FORMAT, VIRTUAL_DATETIME_STORAGE_TIMEZONE) . "'", $this->dateFormat, TRUE);
  ...
  protected function opSimple($field) {
    ...
    $value = $this->query->getDateFormat("'" . $this->dateFormatter->format($value, 'custom', VIRTUAL_DATETIME_VIRTUAL_DATETIME_STORAGE_FORMAT, VIRTUAL_DATETIME_STORAGE_TIMEZONE) . "'", $this->dateFormat, TRUE);
