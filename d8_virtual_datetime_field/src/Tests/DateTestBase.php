...
namespace Drupal\virtual_datetime\Tests;

@trigger_error('\Drupal\virtual_datetime\Tests\DateTestBase is deprecated in Drupal 8.4.0 and will be removed before Drupal 9.0.0. Use \Drupal\Tests\BrowserTestBase instead. See https://www.drupal.org/node/2780063.', E_USER_DEPRECATED);
...
/**
 * Provides a base class for testing Virtual_Datetime field functionality.
 *
...
abstract class DateTestBase extends WebTestBase {
   ...
   * @var array
   */
  public static $modules = ['node', 'entity_test', 'virtual_datetime', 'field_ui'];
  ...
  protected function createField() {
    ...
    $this->fieldStorage = FieldStorageConfig::create([
      ...
      'type' => $type,
      'settings' => ['virtual_datetime_type' => Virtual_DateTimeItem::VIRTUAL_DATETIME_TYPE_DATE],
    ]);
